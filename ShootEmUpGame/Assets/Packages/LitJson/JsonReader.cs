...
namespace LitJson
{
    ...
    public class JsonReader
    {
        ...
        static NumberFormatInfo number_format = NumberFormatInfo.InvariantInfo;
        ...
        private void ProcessNumber (string number)
        {
            if (number.IndexOf ('.') != -1 ||
                ...
                double n_double;
                if (Double.TryParse (number, NumberStyles.Any, number_format, out n_double)) {
            ...
            int n_int32;
            if (Int32.TryParse (number, NumberStyles.Integer, number_format, out n_int32)) {
                token = JsonToken.Int;
                token_value = n_int32;
            ...
            long n_int64;
            if (Int64.TryParse (number, NumberStyles.Integer, number_format, out n_int64)) {
